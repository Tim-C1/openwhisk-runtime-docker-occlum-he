...
copy_bom -f ../python-glibc-pagerank.yaml --root image --include-dir /opt/occlum/etc/template
...
# Run the python demo
echo -e "${BLUE}occlum run /bin/python3 pagerank.py${NC}"
occlum run /bin/python3 pagerank.py
