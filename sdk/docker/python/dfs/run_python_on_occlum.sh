...
copy_bom -f ../python-glibc-dfs.yaml --root image --include-dir /opt/occlum/etc/template
...
# Run the python demo
echo -e "${BLUE}occlum run /bin/python3 dfs.py${NC}"
occlum run /bin/python3 dfs.py
