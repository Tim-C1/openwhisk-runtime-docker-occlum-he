...
copy_bom -f ../python-glibc-dynamic-html.yaml --root image --include-dir /opt/occlum/etc/template
...
# Run the python demo
echo -e "${BLUE}occlum run /bin/python3 dynamic-html.py${NC}"
occlum run /bin/python3 dynamic-html.py
